        ...
        <div className="container md:w-5/6 px-2 md:px-0 mx-auto py-9">
            <div className='grid md:grid-cols-4 grid-cols-1 justify-center gap-10 pt-8'>
              <div className='flex flex-col'>
                <h2 className='text-green-400 font-sans'>Made by Ahnaf Tahsin</h2>
                <p className='text-md text-gray-300 md:mt-8 md:mb-20 my-4'>625 E Franklin Ave, Minneapolis, <br/>  MN 55404, USA</p>
                <p className='text-md text-gray-300'>@ 2021 <a className='underline text-green-400 font-sans' href="https://ahnaftahsin.netlify.app">Ahnaf Tahsin</a>. All rights reserved.</p>
              </div>
              <div>
                <div>
              ...
              <div>
                  ...
                  <ul  className='flex flex-col md:gap-5 gap-2'>
                    <li className='flex gap-5 text-md text-gray-300 items-center'>
                        <span><a href="tel:+012345678910"> <IoCallOutline className='text-2xl'/> </a></span>
                        <span><a href="tel:+012345678910">Phone</a></span>
                    </li>
                    <li className='flex gap-5 text-md text-gray-300 items-center'>
                        <span><a href="mailto:ahnaftahsin11@gmail.com"> <HiOutlineMail className='text-2xl' /></a></span>
                        <span><a href="mailto:ahnaftahsin11@gmail.com">Mail</a></span>
                    </li>
                    <li className='flex gap-5 text-md text-gray-300 items-center my-6 ml-3'>
                        <span><a href="#"> <FaFacebookF className='text-2xl' /></a></span>
                        <span><a href="#"><BsInstagram className='text-2xl'/> </a></span>
                        <span><a href="#"><AiOutlineTwitter className='text-2xl'/></a></span>
                    </li>
                  </ul>
                </div>
              </div>
